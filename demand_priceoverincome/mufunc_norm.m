...
%   vfull - [N x (K*ns)] random-coefficient draws.
%   dfull - [N x (D*ns)] log income draws. Inverse income, 1./EXP(dfull),
%           enters the demographic interaction for the price/income model.
