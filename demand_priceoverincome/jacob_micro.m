...
%   x2               - random-coefficient product characteristics.
%
% FILE INPUT
%   Loads ps2_<ns>.mat, which must contain the simulation draws, including V
%   and DEMOGR. Inverse income is used for the demographic derivative.
%
% SOURCE
%   Modified from Aviv Nevo's random-coefficients demand code.

global ns theti thetj cdid cdindex x2
